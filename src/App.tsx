        ...
        <div className="container mx-auto pt-10 md:pt-12 lg:pt-14 pb-20 px-5 md:px-0">
          ...
          <div className="max-w-[600px] w-full mx-auto bg-slate-50 py-6 px-5 mt-10 md:mt-12 lg:mt-14">
            ...
            <div className="flex gap-x-3">
              <button type="button" className="py-2 px-3 md:px-4 bg-blue-500 font-medium text-sm md:text-base text-white rounded">Add Todo</button>
              <button type="button" className="py-2 px-3 md:px-4 font-medium text-base text-gray-700 rounded">Edit Todo</button>
              <button type="button" className="font-medium text-sm md:text-base text-rose-700 border-b border-rose-700 ml-auto">Delete Selected Todos</button>
            </div>
          </div>
        </div>
      </main>
